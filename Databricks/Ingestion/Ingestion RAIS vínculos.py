...
from pyspark.sql.functions import col,format_number,regexp_replace,when,lit
...
df_rais_centro_oeste=spark.read.csv("/mnt/rais2020/bronze/RAIS_VINC_PUB_CENTRO_OESTE.txt.gz", encoding='ISO-8859-1', header=True, sep=";")

# COMMAND ----------

df_rais_nordeste=spark.read.csv("/mnt/rais2020/bronze/RAIS_VINC_PUB_NORDESTE.txt.gz", encoding='ISO-8859-1', header=True, sep=";")

# COMMAND ----------

df_rais_norte=spark.read.csv("/mnt/rais2020/bronze/RAIS_VINC_PUB_NORTE.txt.gz", encoding='ISO-8859-1', header=True, sep=";")

# COMMAND ----------

df_rais_sul=spark.read.csv("/mnt/rais2020/bronze/RAIS_VINC_PUB_SUL.txt.gz", encoding='ISO-8859-1', header=True, sep=";")

# COMMAND ----------

df_rais_mg=spark.read.csv("/mnt/rais2020/bronze/RAIS_VINC_PUB_MG_ES_RJ.txt.gz", encoding='ISO-8859-1', header=True, sep=";")

# COMMAND ----------

df_rais_sp=spark.read.csv("/mnt/rais2020/bronze/RAIS_VINC_PUB_SP.txt.gz", encoding='ISO-8859-1', header=True, sep=";")
...
# MAGIC %md
# MAGIC #### 6.3 Type of physical disability
...
# MAGIC %md
# MAGIC #### 6.5 Type of employment relationship
...
# MAGIC %md
# MAGIC #### 6.6 Type of Ecomomic subsector
...
df_rais_brasil_clean_sex = df_rais_brasil_clean_subsetor.withColumn("sexo_trabalhador", when(df_rais_brasil_clean_subsetor["Sexo Trabalhador"] == 1,"Masculino")\
                                                .when(df_rais_brasil_clean_subsetor["Sexo Trabalhador"] == 2,"Feminino")
                                                .otherwise("Ignorado")).drop("Sexo Trabalhador")

# COMMAND ----------

# MAGIC %md
# MAGIC #### 6.7 Insert year

# COMMAND ----------

df_rais_vinculos=df_rais_brasil_clean_sex.withColumn("Ano", lit("2020"))

# COMMAND ----------

df_rais_vinculos.write.parquet("/mnt/rais2020/silver/rais_vinculos.parquet",mode="overwrite")
